...
import static Подготовительный.Test8.CrossZero5.SIZE_X;
import static Подготовительный.Test8.CrossZero5.SIZE_Y;
import static Подготовительный.Test8.CrossZero5.emtpyField;
...
public class StartNewGameWindow extends JFrame {
    ...
    // 16
    StartNewGameWindow(GameWindow1 gameWindow1) {
    ...
    void btnStartGameClick() {
        ...
        int cellsNumber = slFieldSize.getValue();
        int winLength = slWinLength.getValue();
        CrossZero5.SIZE_X = cellsNumber;
        CrossZero5.SIZE_Y = cellsNumber;
        CrossZero5.SIZE_WIN = winLength;
        CrossZero5.fieldg = new char[SIZE_X][SIZE_Y];
        emtpyField();
        Map.setMODE(gameMode);
        setVisible(false);
    }
